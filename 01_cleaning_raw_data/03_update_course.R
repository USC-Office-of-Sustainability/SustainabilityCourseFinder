...
library(readxl)
library(dplyr)
courses <- read.csv("usc_courses_with_school_20243.csv")
courses_to_update <- read_excel("Template_for_Adding_Courses_to_Sustainability_Course_Finder.xlsx")
...
write.csv(courses_new,
          "usc_courses_with_school_updated_20243.csv",
          row.names = FALSE)
