...
recent_courses <- read.csv("streamlined_data/generated_shiny_app_data/recent_courses.csv")
...
write.csv(ge_recent, "streamlined_data/generated_shiny_app_data/ge_data.csv", row.names = FALSE)
