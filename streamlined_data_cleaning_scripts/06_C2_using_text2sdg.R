...
usc_pwg_keywords <- read.csv("streamlined_data/generated_shiny_app_data/usc_keywords.csv")
...
usc_courses <- read.csv("streamlined_data/04_B2_20251_only.csv")
...
write.csv(course_sdg_data, "streamlined_data/06_C2_20251_only_course_sdg_data.csv", row.names = FALSE)
...
write.csv(single_rows,
          "streamlined_data/06_C2_20251_only_usc_courses_full.csv",
          row.names = FALSE)
...
write.csv(recent_courses, "streamlined_data/06_C2_20251_only_recent_courses.csv", row.names=FALSE)
